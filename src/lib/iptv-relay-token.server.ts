...
function getSecret(): Buffer {
  const raw = process.env.IPTV_PROXY_SIGNING_KEY || process.env.IPTV_ENCRYPTION_KEY;
  if (!raw) {
    throw new Error("IPTV_PROXY_SIGNING_KEY or IPTV_ENCRYPTION_KEY must be configured");
  }
